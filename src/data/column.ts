...
export const columns: ColumnArticle[] = [
  {
    ...
    excerpt:
      "国産の生ライチが穫れるのは1年のうちほんの数週間。6月下旬から7月ごろという旬の時期と、その短さの理由をやさしく解説します。",
    category: "lychee",
    date: "2026-05-20",
    updated: null,
    ...
    body: [
      {
        type: "p",
        text: "「ライチはいつが食べごろですか」。この時期になると、いちばん多くいただく質問です。答えを先にお伝えすると、国内で育ったライチが穫れるのは6月下旬から7月ごろ。1年のうち、ほんの数週間だけです。",
      },
      { type: "h2", text: "国産ライチの旬は6月下旬から7月ごろ" },
      {
        type: "p",
        text: "ライチはもともと暖かい地域の果物です。日本では、鹿児島・宮崎・沖縄など南のほうの地域で育てられていて、初夏から真夏にかけて実が色づきます。その年の気温や雨の降り方によって、収穫の始まりは前後します。",
      },
      {
        type: "p",
      ...
      {
        type: "note",
        text: "山川園芸の今季の販売時期は、収穫の状況を見ながらお知らせしています。最新の状況はオンラインショップのページをご覧ください。",
      },
    ],
    related: [
